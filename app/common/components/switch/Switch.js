...
export class Switch extends Component {
	...
	constructor(props, context) {
		...
		this.state = {
			value: props.value,
			transformSwitch: new Animated.Value(props.value ? props.circleSize / 3.2 : -props.circleSize / 3.2),
	...
	animateSwitch(value, cb = () => { }) {
		Animated.parallel([
			Animated.spring(this.state.transformSwitch, {
				toValue: value ? this.props.circleSize / 3.2 : -this.props.circleSize / 3.2
			}),
			...
			>
				<Animated.View
					style={[
						styles.container,
            containerStyle,
						{ backgroundColor: interpolatedColorAnimation, width: circleSize * 1.7, height: barHeight ? barHeight : circleSize, borderRadius: circleSize }
					]}
				>
					<Animated.View
						style={[
							styles.animatedContainer,
							{ left: transformSwitch, width: circleSize * 1.7 },
						]}
					>
